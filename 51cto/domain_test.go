...
// HTTP behaviour is covered in 51cto_test.go.

func TestDomainInfo(t *testing.T) {
	info := Domain{}.Info()
	if info.Scheme != "51cto" {
		t.Errorf("Scheme = %q, want 51cto", info.Scheme)
	}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "51cto://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("51cto", "about")
	if err != nil || got.String() != "51cto://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want 51cto://page/about", got.String(), err)
	}
}
