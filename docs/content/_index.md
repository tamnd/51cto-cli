---
title: "cto"
description: "Browse 51CTO, China's IT community"
heroTitle: "51cto, from the command line"
heroLead: "Browse 51CTO, China's IT community One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
cto links <path>           # the pages it links to, each addressable
cto serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading 51cto by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address 51cto as
  `51cto://` URIs and follow links across sites. See
